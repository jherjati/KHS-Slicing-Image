          ...
          <div className='grid grid-rows-2  bg-architecture bg-cover bg-center rounded-[1rem] w-[90%]  h-[80%]'>
            <div className='grid grid-cols-2 row-start-2'>
              <div className='outline outline-[16px] md:outline-[28px] bg-white w-[100%]  outline-white rounded-tr-lg'>
                <Image src='/architectureimage.png' className='' alt='' width='300' height='300' />
                <h1 className='text-blacky text-[14px] leading-[17px] md:text-[18px] md:leading-[22px] font-[700] font-inter  '>Bangunan TIC & Komersial di Labuan Baju</h1>
                <p className='text-grey text-[12px] md:text-[16px] md:leading-[19px] leading-[15px] font-[400] font-inter pb-[10px]'>Architecture & Construction</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className='px-[20px] md:px-[120px] '>
        ...
        <div className='pt-8'>
          <div className='lg:hidden border border-black rounded-lg text-center'>
            <Dropdown title='Select Section' texts={["Architectural Planning", "Detail Engineering Design Planning", "Construction Management", "Design and Build"]} />
          </div>
        </div>
        <div className='flex flex-col lg:grid lg:grid-cols-4 lg:divide-x'>
          <div className='col-span-3 flex flex-col space-y-8 pt-[5%] pr-[3%]'>
            ...
            <div id='design' className=' flex flex-col space-y-8 '>
