...
const ContactUs = () => {
  return (
    <div className='pt-[70px] pb-[90px] flex flex-col px-5  md:px-[120px] relative'>
      <Image src={accentGreen} alt='' className='md:block hidden absolute top-0 left-0' />
      <Image src={accentRedBlue} alt='' className='md:block hidden absolute top-1/4 right-0' />
      <Image src={accentRedBlueHalf} alt='' className='md:hidden absolute top-1/4 right-0' />
      <div className=' flex flex-col pb-[60px] space-y-8 md:grid md:grid-cols-3  content-center pt-10  md:pt-[90px]'>
        <div className='md:col-span-2 flex justify-center flex-col space-y-2 md:space-y-8 col-span-1 mx-3'>
          <h1 className='text-slate-900 font-bold  text-[32px] md:text-left text-center md:text-5xl font-quicksand '>Get in Touch With Us</h1>
          <div className='flex flex-col gap-4 md:gap-6 pb-5'>
            <div className='flex items-start space-x-1 gap-2'>
              ...
              <span>
                <p className='text-[#8F8C8C] md:text-base text-sm '>Pondok Pinang Center C-34 Jalan Ciputat Raya,</p>
                <p className='text-[#8F8C8C] md:text-base text-sm '>Kota Jakarta Selatan, DKI Jakarta 12310</p>
              </span>
            </div>
            <div className='flex items-center space-x-1 gap-2'>
              <MdEmail className='text-sm md:text-2xl text-[#8F8C8C] cursor-pointer  hover:text-sky-200' />
              <p className='text-[#8F8C8C] md:text-base text-sm'>info@handalselaras.com</p>
            </div>
            <div className='flex items-center space-x-1 gap-2'>
      ...
      <div className='flex  flex-col md:grid md:grid-cols-7 gap-10 relative'>
        <div className='md:col-span-3 grid grid-cols-2 rounded-3xl shadow p-5 gap-5 bg-white'>
          ...
          <button className=' w-full col-span-2 py-2 rounded-xl bg-blue-dark  text-white font-semibold hover:bg-opacity-80 transition-opacity ease-in-out'>Kirim</button>
        </div>
