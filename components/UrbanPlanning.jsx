        ...
        <div className="col-span-3 flex flex-col space-y-8 pt-[5%] pr-[3%]">
          <div className=" flex flex-col space-y-8 ">
            ...
            <p className="text-slate-500 tracking-wide text-sm md:text-xl font-quicksand ">
              ...
              capability in preparing Spatial Plans both in general and detailed
              scales. Technology and Speed are our advantages in the preparation
              of spatial planning.
            </p>
            <p className="text-slate-500 tracking-wide text-sm md:text-xl font-quicksand ">
          ...
          <div className=" flex flex-col space-y-8 ">
            ...
            <p className="text-slate-500 tracking-wide text-sm md:text-xl font-quicksand">
              HANDAL SELARAS GROUP is supported by urban planners who have the
              capability in preparing Spatial Plan documents and studies related
              to regional development in general and sectoral. The General
              Planning that we have worked on is the Regional Government Work
              Plan (RKP), the Regional Economic Development Master Plan (RIPE),
              the Regional Tourism Master Plan (RIPDA), and various studies in
              the field of housing finance development.
            </p>
            <Image
              className="rounded-lg"
          ...
          <div className=" flex flex-col space-y-8 ">
            ...
            <p className="text-slate-500 tracking-wide text-sm md:text-xl font-quicksand">
              ...
              Demand and price growth in all property sectors, including land as
              raw material, increased quite high. The use of a large area of
              land in strategic locations must be carried out carefully.
              Business calculations need to be done so that the value of the
              benefits obtained compared to the investment invested can later be
              optimal.
            </p>
            <p className="text-slate-500 tracking-wide text-sm md:text-xl font-quicksand">
          ...
          <div className=" flex flex-col space-y-8 ">
            ...
            <p className="text-slate-500 tracking-wide text-sm md:text-xl font-quicksand">
              HANDAL SELARAS GROUP has a value in innovation and technology that
              encourages planning and studies to be easily understood/applied
              with information technology innovation.
            </p>
            <p className="text-slate-500 tracking-wide text-sm md:text-xl font-quicksand">
