        ...
        >
          <div className='col-span-3 flex flex-col space-y-5 md:space-y-8 md:pt-16 lg:pr-[3%]'>
            ...
            <div id='aerial' className=' flex flex-col space-y-5 md:space-y-8 '>
              <h1 className='text-blacky text-sedangmobile mt-5 md:mt-0 md:text-sedang2 font-quicksand'>Photogrammetry</h1>
              <p className='text-justify text-grey text-kecilmobile md:text-kecil font-inter'>
                HANDAL SELARAS GROUP provides Photogrammetry Services using the Unmanned Aerial Vehicle (UAV) vehicle with the Photogrammetry method. We provide various sensors according to survey needs. The advantages of our services are:
              </p>
            ...
            <div id='thermo' className=' flex flex-col space-y-5 md:space-y-8 '>
              <h1 className='text-blacky text-sedangmobile mt-5 md:mt-0 md:text-sedang2 font-quicksand'>Thermal Inspection</h1>
              {/* <p className='text-justify text-grey text-kecilmobile md:text-kecil font-inter'>
              ...
              <p className='text-justify text-grey text-kecilmobile md:text-kecil font-inter'>
                Thermal surveys using UAVs make it possible to carry out detailed surveys with the aim of obtaining temperature anomalies in a survey object from an angle that humans cannot see and reach.
              </p>
              <p className='text-grey text-kecilmobile md:text-kecil font-inter text-justify'>
