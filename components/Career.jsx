    ...
    <div className='mt-[70px] relative'>
      ...
      <div className='flex flex-col space-y-12 md:space-y-20 px-[20px] md:px-[120px] text-black relative border-b pb-16'>
        <Image
          src={acRedBlue}
          alt='Accent'
          className='hidden md:block select-none absolute top-0 right-0'
        />
        <Image
          src={acRedBlueHalf}
          alt='Accent'
          className='md:hidden select-none absolute top-[100px] right-0'
        />
        {/* subpage 1 */}
        <div className='flex  md:w-1/2 flex-col space-y-2 md:space-y-6 col-span-1 mx-3 relative'>
          ...
          <div
            className='text-grey text-kecilmobile md:text-kecil font-inter '
        ...
        <div className='flex flex-col lg:grid lg:grid-cols-3 gap-8 relative '>
          <div className=' bg-white  flex lg:grid  rounded-[1rem] shadow-md p-[4%]'>
            ...
            <div dangerouslySetInnerHTML={{ __html: section2Cards[0] }}>
          ...
          <div className=' bg-white  flex lg:grid  rounded-[1rem] shadow-md p-[4%]'>
            ...
            <div dangerouslySetInnerHTML={{ __html: section2Cards[1] }}>
              {/* <div className='text-2xl font-semibold text-slate-900'>
                Inspire
              </div>
          ...
          <div className=' bg-white  flex lg:grid  rounded-[1rem] shadow-md p-[4%]'>
            ...
            <div dangerouslySetInnerHTML={{ __html: section2Cards[2] }}>
              {/* <div className='text-2xl font-semibold text-slate-900'>
                Responsive
              </div>
          ...
          <div className='pt-8  flex flex-col lg:hidden space-y-8 '>
            {careeractivity.map(({ activity, text, key }) => {
              return (
                ...
                >
                  <Image
                    className='col-span-2 md:w-full w-[100px]'
                    width='800'
                    height='900'
                    src={activity}
                    alt=''
        ...
        <div className='flex flex-col space-y-4 '>
          ...
          <div className='flex flex-col lg:grid lg:grid-cols-5 gap-8'>
            <form className='col-span-4'>
              ...
              <div
                className='h-14 flex items-center justify-between gap-5 border rounded-lg bg-gray-50  border-gray-300 pr-5 cursor-text'
                onClick={() => searchRef?.current?.focus()}
              >
                <input
                  type='text'
                  ref={searchRef}
                  className='w-full h-full px-5 text-kecil font-quicksand  rounded-lg focus:outline-none bg-gray-50 '
                  id='default-search'
                  placeholder='Cari Posisi yang tersedia'
                  required
                />
          ...
          <div className='flex flex-col  lg:grid lg:grid-cols-3 gap-5 lg:gap-12  pb-20'>
            {section3Jobs.map(
              ({ databaseId, mediaItemUrl, altText, title, caption }) => {
                return (
                  <div
                    key={databaseId}
                    className=' grid grid-cols-6 gap-4 lg:flex lg:flex-col justify-items-center content-center  rounded-[1rem] bg-white shadow-md px-[5%] py-[5%]'
                  >
                    ...
                    <div className='col-span-4  flex flex-col justify-center space-y-[8px]'>
                      ...
                      <div
                        className='text-grey text-kecilmobile md:text-kecil'
